...
export const metadata = {
  title: "About Asay Global",
  description:
    "24 years of experience delivering premium architectural solutions: steel, aluminum, glass and decorative products across 38 countries.",
  keywords: [
    "About Asay Global",
    "company overview",
  ...
  openGraph: {
    title: "About Asay Global",
    description:
      "Premium architectural and engineering solutions with 24 years of experience across 38 countries.",
    url: "/about",
    type: "article",
  },
};
