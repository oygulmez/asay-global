...
export const metadata = {
  ...
  description:
    "Premium decorative wall panels, façade cladding and decking systems that combine aesthetics with performance.",
  keywords: [
    "decorative products",
    "wall panels",
    "façade cladding",
  ...
  alternates: { canonical: "/services/interior-and-exterior-decorative-products" },
  openGraph: {
    title: "Interior & Exterior Decorative Products | Asay Global",
    description:
      "Decorative architectural solutions for interiors and exteriors: panels, cladding and decking.",
