...
export const metadata = {
  ...
  description:
    "Modern aluminum systems for façades, windows, doors and structural glazing with superior performance and design flexibility.",
  keywords: [
    "aluminum systems",
    "façades",
    "windows",
  ...
  alternates: { canonical: "/services/aluminum-architectural-solutions" },
  openGraph: {
    title: "Aluminum Architectural Solutions | Asay Global",
    description:
      "High‑performance aluminum architectural solutions for modern buildings.",
