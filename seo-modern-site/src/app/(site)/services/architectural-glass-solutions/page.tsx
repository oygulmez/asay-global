...
export const metadata = {
  ...
  description:
    "Energy‑efficient glazing, solar control, acoustic performance and safety glass solutions for modern architecture.",
  keywords: [
    "architectural glass",
  ...
  alternates: { canonical: "/services/architectural-glass-solutions" },
  openGraph: {
    title: "Architectural Glass Solutions | Asay Global",
    description:
      "High‑performance glass systems for façades, skylights, canopies and interior applications.",
