...
export const metadata = {
  ...
  description:
    "High‑performance steel structures and framing systems engineered for strength, durability and modern architecture.",
  keywords: [
    "steel framings",
    "structural steel",
  ...
  alternates: { canonical: "/services/steel-framings" },
  openGraph: {
    title: "Steel Framings | Asay Global",
    description:
      "Structural steel solutions, frameworks, industrial buildings and custom fabrication.",
