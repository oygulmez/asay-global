...
export const metadata = {
  ...
  description:
    "Find Asay Global authorized dealers and representatives. Contact regional partners for sales and support.",
  keywords: [
    "authorized dealers",
    "representatives",
    "resellers",
  ...
  openGraph: {
    title: "Authorized Dealers | Asay Global",
    description:
      "Official partners and contact points for Asay Global worldwide.",
    url: "/dealers",
    type: "website",
  },
};
