                                ...
                                <div className="relative overflow-hidden select-none">
                                    ...
                                    <div className="mx-auto max-w-7xl px-0">
                                        <Logos3 heading={undefined} logos={[
                                            ...
                                            { id: "logo-hafele", description: "Hafele", image: "/images/brands-logo/brands-anasayfa/hafele-logo.webp", className: "h-12 w-auto" },
                                            { id: "logo-roto", description: "Roto", image: "/images/brands-logo/brands-anasayfa/roto-logo.svg", className: "h-12 w-auto" },
                                            { id: "logo-deceuninck", description: "Deceuninck", image: "/images/brands-logo/brands-anasayfa/deceuninck.webp", className: "h-12 w-auto" },
                                            { id: "logo-siegenia", description: "Siegenia", image: "/images/brands-logo/brands-anasayfa/siegenia.webp", className: "h-12 w-auto" },
                                            { id: "logo-aluplast", description: "Aluplast", image: "/images/brands-logo/brands-anasayfa/aluplast-logo.webp", className: "h-12 w-auto" },
                                            ...
                                            { id: "logo-lavita", description: "Lavita", image: "/images/brands-logo/brands-anasayfa/lavita-door-logo.webp", className: "h-12 w-auto" },
                                            { id: "logo-sapa", description: "Sapa", image: "/images/brands-logo/brands-anasayfa/sapa-logo.webp", className: "h-12 w-auto" },
                                        ]} />
                                    </div>
                                </div>
                            </div>
                ...
                items={[
                    {
                        ...
                        image: "/images/services/interior-exterior/Interior-and-Exterior-Decorative-Products-1.webp",
                    },
                    {
                        id: "service-2", 
                    ...
                    },
                    {
                        ...
                        image: "/images/services/aluminum-solutions/Aluminum-Architectural-Solutions-img--1.webp",
                    },
                    {
                        id: "service-4",
                        ...
                        image: "/images/services/glass-solutions/architectural-glass-gallery-1.webp",
                    },
                    {
                        id: "service-5",
