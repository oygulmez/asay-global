...
const Logos3 = ({
  ...
  return (
    <section className={"py-0"}>
      ...
      <div className={heading ? "pt-10 md:pt-16 lg:pt-20" : "pt-0"}>
                  ...
                  <div className="mx-8 flex shrink-0 items-center justify-center">
                    <div>
                      <img
                        ...
                        className={`${logo.className ?? "h-8 w-auto"} object-contain opacity-80 hover:opacity-100 grayscale hover:grayscale-0 transition-all duration-300`}
                      />
                    </div>
                  </div>
                </CarouselItem>
