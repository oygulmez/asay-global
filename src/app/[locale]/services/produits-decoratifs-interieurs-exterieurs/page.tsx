...
import SiteInteriorAndExteriorDecorativeProducts from '@/app/(site)/services/interior-and-exterior-decorative-products/page';
...
export default function ProduitsDecoratifsInterieursExterieursPage() {
