...
export default function GardenGateSystemPage() {
    ...
    try {
      const response = await fetch("https://formspree.io/f/movkdgoa", {
        ...
        body: JSON.stringify({
          ...
          subject: "Garden Gate System Inquiry",
  ...
  const productSchema = {
    ...
    description:
      "The Garden Gate System by Asay Global is a durable aluminum gate solution designed to complement fence and perimeter systems, providing defined entry points with lasting security.",
    brand: {
      "@type": "Brand",
      name: "Asay Global",
    },
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Where can the Garden Gate System be used?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "The Garden Gate System is suitable for residential gardens, villas, private properties, commercial sites, and controlled outdoor access areas.",
        },
      },
      {
        "@type": "Question",
        name: "Is the Garden Gate compatible with fence systems?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. It is designed to integrate seamlessly with fence and perimeter systems for a unified appearance.",
        },
      },
      {
        "@type": "Question",
        name: "Is the Garden Gate suitable for outdoor use?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Absolutely. Its aluminum structure and surface finish options provide strong resistance to corrosion and weather conditions.",
        },
      },
      {
        "@type": "Question",
        name: "Can the Garden Gate be customized?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. The system can be adapted in terms of size, configuration, and surface finish to meet project-specific requirements.",
        },
      },
      {
        "@type": "Question",
        name: "Does the Garden Gate System offer long-term durability?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. High-quality materials and precise engineering ensure reliable operation and durability over time.",
        },
      },
    ],
  };
  ...
  const content = (
    <>
      <Script
        id="garden-gate-product-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(productSchema) }}
      />
      <Script
        id="garden-gate-faq-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }}
      />
      <PageHeader
        title="Garden Gate System"
        description="Defined Entry, Lasting Security – a durable aluminum gate system designed to complement fence and perimeter solutions."
        breadcrumbItems={[
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <section className="pt-4">
                ...
                <p
                  ...
                  style={{ color: "#565656" }}
                >
                  <strong>Gate Systems</strong> by{" "}
                  <strong>Asay Global</strong> are designed to complement{" "}
                  <strong>fence</strong> and <strong>perimeter solutions</strong>{" "}
                  by providing <strong>controlled access</strong> with a{" "}
                  <strong>consistent architectural appearance</strong>.
                  Developed for <strong>residential gardens</strong>,{" "}
                  <strong>villas</strong>, <strong>commercial properties</strong>{" "}
                  and <strong>semi-public areas</strong>, these systems combine{" "}
                  <strong>durability</strong>, <strong>ease of use</strong>, and{" "}
                ...
                <p
                  ...
                  style={{ color: "#565656" }}
                >
                  The <strong>Garden Gate System</strong> by{" "}
                  <strong>Asay Global</strong> offers a{" "}
                  <strong>reliable and aesthetic entrance solution</strong> that{" "}
                  <strong>integrates seamlessly</strong> with{" "}
                  <strong>fencing</strong> and <strong>boundary systems</strong>.
                  Its <strong>robust aluminum construction</strong> ensures{" "}
                  <strong>long-term performance</strong>, while the{" "}
                  <strong>clean profile design</strong> supports both{" "}
                  <strong>modern</strong> and <strong>traditional</strong>{" "}
                  architectural styles. Designed for{" "}
                  <strong>smooth operation</strong> and{" "}
                  <strong>easy installation</strong>, the Garden Gate System
                  delivers a balanced solution where{" "}
                  <strong>security</strong>, <strong>functionality</strong> and{" "}
                  <strong>visual harmony</strong> come together.
                </p>
              </section>
              ...
              <section className="pt-4">
                <div className="space-y-12">
                  <h2
                    ...
                    style={{ color: "black" }}
                  >
                    Frequently Asked Questions – Garden Gate
                  </h2>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Where can the Garden Gate System be used?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                            style={{ color: "#565656" }}
                          >
                            The <strong>Garden Gate System</strong> is suitable
                            for <strong>residential gardens</strong>,{" "}
                            <strong>villas</strong>,{" "}
                            <strong>private properties</strong>,{" "}
                            <strong>commercial sites</strong>, and{" "}
                            <strong>controlled outdoor access areas</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Is the Garden Gate compatible with fence systems?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                          ...
                          >
                            ...
                            <strong>integrate seamlessly</strong> with{" "}
                            <strong>fence</strong> and{" "}
                            <strong>perimeter systems</strong> for a{" "}
                            <strong>unified appearance</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Is the Garden Gate suitable for outdoor use?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                            style={{ color: "#565656" }}
                          >
                            Absolutely. Its <strong>aluminum structure</strong>{" "}
                            and <strong>surface finish options</strong> provide{" "}
                            <strong>strong resistance</strong> to{" "}
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Can the Garden Gate be customized?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                            style={{ color: "#565656" }}
                          >
                            Yes. The system can be{" "}
                            <strong>adapted in terms of size</strong>,{" "}
                            <strong>configuration</strong>, and{" "}
                            <strong>surface finish</strong> to meet{" "}
                            <strong>project-specific requirements</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Does the Garden Gate System offer long-term
                          durability?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            ...
                            style={{ color: "#565656" }}
                          >
                            Yes. <strong>High-quality materials</strong> and{" "}
                            <strong>precise engineering</strong> ensure{" "}
                            <strong>reliable operation</strong> and{" "}
                            <strong>durability over time</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                ...
                >
                  <div className="relative z-10">
                    <h2 className="text-[1.875rem] font-semibold mb-4 text-white">
                      Complete Your Perimeter Design
                    </h2>
                    <p className="text-[1rem] leading-relaxed mb-8 text-white/95 max-w-2xl">
                      Enhance your <strong>fence system</strong> with a{" "}
                      <strong>Garden Gate System</strong> designed for{" "}
                      <strong>consistency</strong>,{" "}
                      <strong>reliability</strong> and{" "}
                      <strong>lasting security</strong>.
                    </p>
