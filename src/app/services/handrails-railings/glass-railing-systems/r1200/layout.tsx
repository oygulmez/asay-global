...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: '/images/handrails-railings/glass-railing-systems/R1200-glass-railing-system/1200-1024x571.webp',
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: ['/images/handrails-railings/glass-railing-systems/R1200-glass-railing-system/1200-1024x571.webp'],
    },
    robots: {
        index: true,
        follow: true,
