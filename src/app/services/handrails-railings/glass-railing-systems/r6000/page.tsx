...
export default function R6000GlassRailingSystemPage() {
    ...
    try {
      const response = await fetch("https://formspree.io/f/movkdgoa", {
        ...
        body: JSON.stringify({
          ...
          subject: "R6000 Glass Railing System Inquiry",
  ...
  const images = [
    {
      src: "/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/r6000-1024x571.webp",
      alt: "R6000 Glass Railing System"
    },
    {
      src: "/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/R6000-A_TD.webp",
      alt: "R6000-A Technical Drawing"
    },
    {
      src: "/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/R6000-B_TD.webp",
      alt: "R6000-B Technical Drawing"
    },
    {
      src: "/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/N16.webp",
      alt: "N16 Component"
    },
    {
      src: "/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/NS1620.webp",
      alt: "NS1620 Component"
    },
    {
      src: "/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/PY16-364x364.webp",
      alt: "PY16 Component"
    },
    {
      src: "/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/PS16-364x364.webp",
      alt: "PS16 Component"
    }
  ];
  ...
  const productSchema = {
    ...
    "description": "One of the most preferred continuous glass base systems thanks to its modern design and ease of installation. Engineered for terraces, entertainment venues, and high-rise buildings.",
    "brand": {
      "@type": "Brand",
      "name": "Asay Global"
    },
    ...
    "image": [
      "https://www.asayglobal.com/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/r6000-1024x571.webp",
      "https://www.asayglobal.com/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/R6000-A_TD.webp",
      "https://www.asayglobal.com/images/handrails-railings/glass-railing-systems/R6000-glass-railing-system/R6000-B_TD.webp"
    ],
    "offers": {
      "@type": "Offer",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Where is the R6000 Glass Railing System typically used?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "R6000 is commonly used in terraces, rooftop areas, entertainment venues, and high-rise buildings where uninterrupted views and high safety standards are required."
        }
      },
      {
        "@type": "Question",
        "name": "What type of glass is compatible with the R6000 system?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The system supports laminated glass panels with thicknesses of 10+10 mm and 8+8 mm, ensuring strength and safety."
        }
      },
      {
        "@type": "Question",
        "name": "What makes R6000 different from framed glass railing systems?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "R6000 is a continuous glass base system, allowing the glass panels to be installed without visible vertical posts, resulting in a cleaner and more transparent appearance."
        }
      },
      {
        "@type": "Question",
        "name": "Is the R6000 system suitable for outdoor use?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. The aluminum base profile is designed for outdoor environments and offers strong resistance to corrosion and environmental conditions."
        }
      },
      {
        "@type": "Question",
        "name": "How high can the R6000 Glass Railing System be installed?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const content = (
    <>
      ...
      />
      <PageHeader
        title="R6000 Glass Railing System"
        ...
        breadcrumbItems={[
          ...
          { label: "R6000 Glass Railing System" },
        ]}
      />
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <section className="pt-4">
                ...
                <p className="text-[1rem] leading-relaxed mb-4" style={{ color: "#565656" }}>
                  <strong>Glass Railing Systems</strong> by <strong>Asay Global</strong> are designed to deliver <strong>maximum transparency</strong> while ensuring <strong>high safety standards</strong> in <strong>modern architectural projects</strong>. Developed for <strong>terraces</strong>, <strong>entertainment venues</strong>, and <strong>high-rise buildings</strong>, these systems combine <strong>structural strength</strong> with <strong>visual openness</strong>. <strong>Continuous glass base solutions</strong> provide <strong>uninterrupted views</strong>, making them a <strong>preferred choice</strong> for <strong>contemporary residential and commercial applications</strong> where <strong>safety and aesthetics</strong> must coexist seamlessly.
                </p>
                <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                  The <strong>R6000 Glass Railing System</strong> by <strong>Asay Global</strong> is one of the most <strong>preferred continuous glass base systems</strong> thanks to its <strong>modern design</strong> and <strong>ease of installation</strong>. Engineered for <strong>demanding environments</strong>, <strong>R6000</strong> offers a <strong>strong and stable glass support structure</strong> while maintaining a <strong>clean and minimalist appearance</strong>. Its <strong>robust aluminum profile</strong> ensures <strong>long-term durability</strong>, while the system's <strong>precise glass positioning</strong> delivers both <strong>safety</strong> and <strong>visual clarity</strong>. <strong>R6000</strong> is an <strong>ideal solution</strong> for projects that prioritize <strong>transparency</strong>, <strong>architectural elegance</strong>, and <strong>reliable performance</strong>.
                </p>
              </section>
              ...
              <section className="pt-4">
                <h2 className="text-[1.875rem] font-semibold mb-6" style={{ color: "black" }}>Technical Specifications – R6000</h2>
              ...
              <section className="pt-4">
                <div className="space-y-12">
                  <h2 className="text-[1.875rem] font-semibold mb-8" style={{ color: "black" }}>Frequently Asked Questions About R6000 Glass Railing System</h2>
                  ...
                  >
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Where is the R6000 Glass Railing System typically used?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>R6000</strong> is commonly used in <strong>terraces</strong>, <strong>rooftop areas</strong>, <strong>entertainment venues</strong>, and <strong>high-rise buildings</strong> where <strong>uninterrupted views</strong> and <strong>high safety standards</strong> are required.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What type of glass is compatible with the R6000 system?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            The system supports <strong>laminated glass panels</strong> with thicknesses of <strong>10+10 mm</strong> and <strong>8+8 mm</strong>, ensuring <strong>strength</strong> and <strong>safety</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What makes R6000 different from framed glass railing systems?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>R6000</strong> is a <strong>continuous glass base system</strong>, allowing the <strong>glass panels</strong> to be installed without <strong>visible vertical posts</strong>, resulting in a <strong>cleaner and more transparent appearance</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Is the R6000 system suitable for outdoor use?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. The <strong>aluminum base profile</strong> is designed for <strong>outdoor environments</strong> and offers <strong>strong resistance</strong> to <strong>corrosion</strong> and <strong>environmental conditions</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          How high can the R6000 Glass Railing System be installed?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
              ...
              <section className="pt-4">
                <div className="relative overflow-hidden rounded-2xl p-12 border border-gray-200 shadow-lg" style={{ backgroundColor: "#998675" }}>
                  <div className="relative z-10">
                    <h2 className="text-[1.875rem] font-semibold mb-4 text-white">Experience Clear Views with R6000</h2>
                    <p className="text-[1rem] leading-relaxed mb-8 text-white/95 max-w-2xl">
                      Discover a <strong>glass railing system</strong> designed to maximize <strong>transparency</strong> without compromising <strong>safety</strong>.
                    </p>
