...
export default function R6200GlassRailingSystemPage() {
    ...
    try {
      const response = await fetch("https://formspree.io/f/movkdgoa", {
        ...
        body: JSON.stringify({
          ...
          subject: "R6200 Glass Railing System Inquiry",
  ...
  const productSchema = {
    ...
    "description": "Oval profile design offering a softer and more aesthetic appearance compared to standard linear systems. Engineered for easy installation and long-term durability in terraces, entertainment venues, and high-rise buildings.",
    "brand": {
      "@type": "Brand",
      "name": "Asay Global"
    },
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Design Feature",
        "value": "Oval Profile Continuous Glass Base System"
      },
      {
        "@type": "PropertyValue",
        "name": "Applications",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What distinguishes the R6200 Glass Railing System from other models?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "R6200 features an oval profile design, providing a more refined and aesthetic appearance while maintaining high safety standards."
        }
      },
      {
        "@type": "Question",
        "name": "Where is the R6200 system commonly used?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "R6200 is commonly used in terraces, entertainment venues, and high-rise buildings where both design and durability are essential."
        }
      },
      {
        "@type": "Question",
        "name": "Is the R6200 system easy to install?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. R6200 is designed with installer-friendly details that simplify alignment and glass placement, reducing installation time."
        }
      },
      {
        "@type": "Question",
        "name": "What glass thicknesses are compatible with R6200?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "Is R6200 suitable for outdoor environments?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. Its aluminum structure and surface finish options provide strong resistance to corrosion and outdoor conditions."
        }
      }
    ]
  };
  ...
  const content = (
    <>
      ...
      />
      <PageHeader
        title="R6200 Glass Railing System"
        ...
        breadcrumbItems={[
          ...
          { label: "R6200 Glass Railing System" },
        ]}
      />
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <section className="pt-4">
                ...
                <p className="text-[1rem] leading-relaxed mb-4" style={{ color: "#565656" }}>
                  <strong>Glass Railing Systems</strong> by <strong>Asay Global</strong> are designed to combine <strong>architectural elegance</strong> with <strong>dependable safety</strong> in <strong>modern building projects</strong>. Developed for <strong>terraces</strong>, <strong>entertainment venues</strong>, and <strong>high-rise buildings</strong>, these systems provide <strong>uninterrupted transparency</strong> while maintaining <strong>strong structural support</strong>. Their <strong>refined profiles</strong> and <strong>durable construction</strong> make them a <strong>preferred solution</strong> for <strong>contemporary residential and commercial architecture</strong>.
                </p>
                <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                  The <strong>R6200 Glass Railing System</strong> by <strong>Asay Global</strong> stands out with its <strong>oval profile design</strong>, offering a <strong>softer and more aesthetic appearance</strong> compared to <strong>standard linear systems</strong>. In addition to its <strong>visual appeal</strong>, <strong>R6200</strong> is engineered for <strong>easy installation</strong> and <strong>long-term durability</strong>. Its <strong>continuous glass base structure</strong> ensures <strong>stable glass positioning</strong> while preserving <strong>clean lines</strong> and <strong>open views</strong>. <strong>R6200</strong> is an <strong>ideal choice</strong> for projects that seek to balance <strong>design sophistication</strong> with <strong>reliable protection</strong>.
                </p>
              </section>
              ...
              <section className="pt-4">
                <h2 className="text-[1.875rem] font-semibold mb-6" style={{ color: "black" }}>Technical Specifications – R6200</h2>
                <div className="space-y-4">
                  ...
                  <div className="flex gap-5 p-5 rounded-xl border border-gray-200 bg-white hover:shadow-md transition-shadow">
                    <div className="flex-1">
                      <h3 className="text-[1.125rem] font-semibold mb-2" style={{ color: "black" }}>Application Areas</h3>
                      <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                        <strong>Terraces</strong>, <strong>entertainment venues</strong>, <strong>high-rise buildings</strong>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section className="pt-4">
                <div className="space-y-12">
                  <h2 className="text-[1.875rem] font-semibold mb-8" style={{ color: "black" }}>Frequently Asked Questions About R6200 Glass Railing System</h2>
                  ...
                  >
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What distinguishes the R6200 Glass Railing System from other models?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>R6200</strong> features an <strong>oval profile design</strong>, providing a more <strong>refined and aesthetic appearance</strong> while maintaining <strong>high safety standards</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Where is the R6200 system commonly used?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>R6200</strong> is commonly used in <strong>terraces</strong>, <strong>entertainment venues</strong>, and <strong>high-rise buildings</strong> where both <strong>design</strong> and <strong>durability</strong> are essential.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Is the R6200 system easy to install?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. <strong>R6200</strong> is designed with <strong>installer-friendly details</strong> that simplify <strong>alignment</strong> and <strong>glass placement</strong>, reducing <strong>installation time</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What glass thicknesses are compatible with R6200?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Is R6200 suitable for outdoor environments?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. Its <strong>aluminum structure</strong> and <strong>surface finish options</strong> provide <strong>strong resistance</strong> to <strong>corrosion</strong> and <strong>outdoor conditions</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
              ...
              <section className="pt-4">
                <div className="relative overflow-hidden rounded-2xl p-12 border border-gray-200 shadow-lg" style={{ backgroundColor: "#998675" }}>
                  <div className="relative z-10">
                    <h2 className="text-[1.875rem] font-semibold mb-4 text-white">Discover the Elegance of R6200</h2>
                    <p className="text-[1rem] leading-relaxed mb-8 text-white/95 max-w-2xl">
                      Choose a <strong>glass railing system</strong> that blends <strong>refined design</strong> with <strong>dependable protection</strong>.
                    </p>
