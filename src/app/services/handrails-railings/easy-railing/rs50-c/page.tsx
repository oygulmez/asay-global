...
export default function RS50CEasyRailingSystemPage() {
    ...
    try {
      const response = await fetch("https://formspree.io/f/movkdgoa", {
        ...
        body: JSON.stringify({
          ...
          subject: "RS50-C Easy Railing System Inquiry",
  ...
  const productSchema = {
    ...
    description:
      "The RS50-C Easy Railing System by Asay Global combines the ease of installation of the RS50 series with integrated glass elements, delivering both transparency and reliable protection for modern residential projects.",
    brand: {
      "@type": "Brand",
      name: "Asay Global",
    },
    ...
    additionalProperty: [
      {
        "@type": "PropertyValue",
        name: "System Type",
        value: "Easy / modular aluminum railing system with integrated glass",
      },
      {
        "@type": "PropertyValue",
        name: "Typical Applications",
        value:
          "Balconies, stairways, terraces, residential projects with emphasis on transparency",
      },
      {
        "@type": "PropertyValue",
        name: "Key Features",
        value:
          "Easy and fast installation, integrated glass solution, simplified connection details, clean and modern architectural appearance",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What does the “C” in RS50-C stand for?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "RS50-C refers to the glass-integrated version of the RS50 Easy Railing System, offering enhanced transparency alongside easy installation.",
        },
      },
      {
        "@type": "Question",
        name: "Where can the RS50-C system be used?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "RS50-C is suitable for balconies, stairways, terraces, and residential projects where visual openness and fast installation are desired.",
        },
      },
      {
        "@type": "Question",
        name: "Is RS50-C suitable for outdoor use?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "How does RS50-C differ from standard RS50?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "RS50-C includes glass components, providing clearer views and a more contemporary appearance compared to the standard RS50 railing system.",
        },
      },
      {
        "@type": "Question",
        name: "Is RS50-C suitable for large residential projects?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Absolutely. Its easy-installation structure and repeatable assembly make RS50-C highly efficient for multi-unit residential developments.",
        },
      },
    ],
  };
  ...
  const content = (
    <>
      ...
      />
      <PageHeader
        title="RS50-C Easy Railing System"
        description="Effortless Installation, Enhanced Transparency – an easy railing system with integrated glass elements for modern residential projects."
        breadcrumbItems={[
          ...
          { label: "RS50-C Easy Railing System" },
        ]}
      />
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <section className="pt-4">
                ...
                >
                  ...
                  <strong>Asay Global</strong> are engineered to simplify
                  installation while maintaining{" "}
                  <strong>high safety standards</strong> and{" "}
                  <strong>contemporary architectural aesthetics</strong>.
                  Designed for <strong>balconies</strong>,{" "}
                  <strong>stairways</strong>, <strong>terraces</strong>, and{" "}
                  <strong>residential applications</strong>, these systems
                  provide practical solutions that balance{" "}
                  <strong>efficiency</strong>, <strong>durability</strong>, and{" "}
                ...
                <p
                  ...
                  style={{ color: "#565656" }}
                >
                  The <strong>RS50-C Easy Railing System</strong> by{" "}
                  <strong>Asay Global</strong> combines the{" "}
                  <strong>ease of installation</strong> of the RS50 series with{" "}
                  <strong>integrated glass elements</strong>, delivering both{" "}
                  <strong>transparency</strong> and{" "}
                  <strong>reliable protection</strong>. Thanks to its{" "}
                  <strong>smart profile design</strong> and{" "}
                  <strong>simplified connection details</strong>, RS50-C allows{" "}
                  <strong>fast and consistent assembly</strong> while enhancing{" "}
                  <strong>visual openness</strong>. Its{" "}
                  <strong>aluminum structure</strong> ensures{" "}
                  <strong>long-term durability</strong> and{" "}
                  <strong>corrosion resistance</strong>, making it an ideal
                  solution for <strong>modern residential projects</strong>{" "}
                  where <strong>safety</strong>, <strong>speed</strong>, and{" "}
                  <strong>aesthetics</strong> must work together seamlessly.
                </p>
              </section>
                  ...
                  <div className="flex gap-5 p-5 rounded-xl border border-gray-200 bg-white hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      >
                        ...
                        ensuring <strong>fall protection</strong> while
                        preserving <strong>visual openness</strong> and{" "}
              ...
              <section className="pt-4">
                <div className="space-y-12">
                  <h2
                    ...
                    style={{ color: "black" }}
                  >
                    Frequently Asked Questions – RS50-C
                  </h2>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          What does the “C” in RS50-C stand for?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                            style={{ color: "#565656" }}
                          >
                            RS50-C refers to the{" "}
                            <strong>glass-integrated version</strong> of the{" "}
                            <strong>RS50 Easy Railing System</strong>, offering{" "}
                            <strong>enhanced transparency</strong> alongside{" "}
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Where can the RS50-C system be used?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Is RS50-C suitable for outdoor use?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          How does RS50-C differ from standard RS50?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                            style={{ color: "#565656" }}
                          >
                            <strong>RS50-C</strong> includes{" "}
                            <strong>glass components</strong>, providing{" "}
                            <strong>clearer views</strong> and a more{" "}
                            <strong>contemporary appearance</strong> compared to
                            the standard RS50 railing system.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger
                          ...
                          style={{ color: "black" }}
                        >
                          Is RS50-C suitable for large residential projects?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p
                            className="text-[1rem] leading-relaxed"
                          ...
                          >
                            Absolutely. Its{" "}
                            <strong>easy-installation structure</strong> and{" "}
                            <strong>repeatable assembly</strong> make{" "}
                            <strong>RS50-C</strong> highly efficient for{" "}
                            <strong>multi-unit residential developments</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                ...
                >
                  <div className="relative z-10">
                    <h2 className="text-[1.875rem] font-semibold mb-4 text-white">
                      Add Transparency with Ease
                    </h2>
                    <p className="text-[1rem] leading-relaxed mb-8 text-white/95 max-w-2xl">
                      Choose <strong>RS50-C Easy Railing System</strong> for{" "}
                      <strong>fast installation</strong> combined with{" "}
                      <strong>modern glass aesthetics</strong>, enhancing both{" "}
                      <strong>safety</strong> and <strong>visual openness</strong>{" "}
                      in your residential projects.
                    </p>
