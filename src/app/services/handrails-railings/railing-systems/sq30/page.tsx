...
export default function SQ30RailingSystemPage() {
    ...
    try {
      const response = await fetch("https://formspree.io/f/movkdgoa", {
        ...
        body: JSON.stringify({
          ...
          subject: "SQ30 Railing System Inquiry",
  ...
  const images = [
    {
      src: "/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30.webp",
      alt: "SQ30 Railing System"
    },
    {
      src: "/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30_TD.webp",
      alt: "SQ30 Technical Drawing"
    },
    {
      src: "/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30-A_TD.webp",
      alt: "SQ30-A Technical Drawing"
    },
    {
      src: "/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30-B_TD.webp",
      alt: "SQ30-B Technical Drawing"
    },
    {
      src: "/images/handrails-railings/railing-systems/SQ30-railing-systems/Ekran-Resmi-2025-01-14-05.38.17.webp",
      alt: "SQ30 Technical Table"
    }
  ];
  ...
  const productSchema = {
    ...
    "description": "Heavier square profile and reinforced structural design, making it ideal for projects that demand a stronger visual impact and elevated safety perception. Supports horizontal, vertical, and glass-holder configurations.",
    "brand": {
      "@type": "Brand",
      "name": "Asay Global"
    },
    ...
    "image": [
      "https://www.asayglobal.com/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30.webp",
      "https://www.asayglobal.com/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30_TD.webp",
      "https://www.asayglobal.com/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30-A_TD.webp",
      "https://www.asayglobal.com/images/handrails-railings/railing-systems/SQ30-railing-systems/SQ30-B_TD.webp"
    ],
    "offers": {
      "@type": "Offer",
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Applications",
        "value": "Balconies, Stairways, Terraces, Open-edge Applications"
      },
      {
        "@type": "PropertyValue",
        "name": "Configurations",
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Design Feature",
        "value": "Heavier Square Profile, Reinforced Structural Design"
      },
      {
        "@type": "PropertyValue",
        "name": "Target Projects",
        "value": "High-end Residential, Commercial Projects"
      }
    ]
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What distinguishes the SQ30 Railing System from SQ20?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "SQ30 features a more robust square profile and reinforced construction, offering greater visual strength and structural presence."
        }
      },
      {
        "@type": "Question",
        "name": "Where is the SQ30 Railing System commonly used?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "SQ30 is commonly used in premium residential and commercial projects, especially in balconies and stairways requiring higher safety perception."
        }
      },
      {
        "@type": "Question",
        "name": "Is SQ30 suitable for outdoor and coastal environments?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. With corrosion-resistant aluminum and protective surface finishes, SQ30 performs reliably in outdoor and demanding environments."
        }
      },
      {
        "@type": "Question",
        "name": "Does SQ30 support glass integration?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. SQ30 can be configured with glass-holder options, allowing transparent designs without compromising safety."
        }
      },
      {
        "@type": "Question",
        "name": "What installation methods are available for SQ30?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "SQ30 supports top mount and side mount installations, providing flexibility for different structural conditions."
        }
      }
    ]
  };
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <section className="pt-4">
                ...
                <p className="text-[1rem] leading-relaxed mb-4" style={{ color: "#565656" }}>
                  <strong>Railing Systems</strong> by <strong>Asay Global</strong> are designed to support <strong>advanced architectural concepts</strong> while ensuring <strong>maximum safety</strong> and <strong>durability</strong>. Developed for <strong>balconies</strong>, <strong>stairways</strong>, <strong>terraces</strong>, and <strong>open-edge applications</strong>, these systems combine <strong>robust aluminum construction</strong> with <strong>precise engineering</strong>. Suitable for both <strong>indoor and outdoor environments</strong>, <strong>Asay Global railing systems</strong> deliver <strong>consistent performance</strong> and a <strong>refined architectural finish</strong>.
                </p>
                <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                  The <strong>SQ30 Railing System</strong> by <strong>Asay Global</strong> stands out with its <strong>heavier square profile</strong> and <strong>reinforced structural design</strong>, making it ideal for projects that demand a <strong>stronger visual impact</strong> and <strong>elevated safety perception</strong>. Designed for <strong>balcony and stairway applications</strong>, <strong>SQ30</strong> supports <strong>horizontal</strong>, <strong>vertical</strong>, and <strong>glass-holder configurations</strong>, offering <strong>flexibility</strong> for <strong>complex architectural requirements</strong>. Its <strong>corrosion-resistant aluminum structure</strong>, combined with <strong>anodized and painted surface options</strong>, ensures <strong>long-term durability</strong> and <strong>aesthetic consistency</strong>. <strong>SQ30</strong> is an <strong>excellent choice</strong> for <strong>high-end residential and commercial projects</strong> where <strong>structure and design</strong> must be equally emphasized.
                </p>
              </section>
              ...
              <section className="pt-4">
                <div className="space-y-12">
                  <h2 className="text-[1.875rem] font-semibold mb-8" style={{ color: "black" }}>Frequently Asked Questions About SQ30 Railing System</h2>
                  ...
                  >
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What distinguishes the SQ30 Railing System from SQ20?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>SQ30</strong> features a more <strong>robust square profile</strong> and <strong>reinforced construction</strong>, offering <strong>greater visual strength</strong> and <strong>structural presence</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Where is the SQ30 Railing System commonly used?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>SQ30</strong> is commonly used in <strong>premium residential and commercial projects</strong>, especially in <strong>balconies and stairways</strong> requiring <strong>higher safety perception</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Is SQ30 suitable for outdoor and coastal environments?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. With <strong>corrosion-resistant aluminum</strong> and <strong>protective surface finishes</strong>, <strong>SQ30</strong> performs reliably in <strong>outdoor and demanding environments</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Does SQ30 support glass integration?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. <strong>SQ30</strong> can be configured with <strong>glass-holder options</strong>, allowing <strong>transparent designs</strong> without compromising <strong>safety</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What installation methods are available for SQ30?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>SQ30</strong> supports <strong>top mount</strong> and <strong>side mount installations</strong>, providing <strong>flexibility</strong> for different <strong>structural conditions</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
              ...
              <section className="pt-4">
                <div className="relative overflow-hidden rounded-2xl p-12 border border-gray-200 shadow-lg" style={{ backgroundColor: "#998675" }}>
                  <div className="relative z-10">
                    <h2 className="text-[1.875rem] font-semibold mb-4 text-white">Experience the Strength of SQ30</h2>
                    <p className="text-[1rem] leading-relaxed mb-8 text-white/95 max-w-2xl">
                      Discover a <strong>railing system</strong> designed for projects that demand <strong>durability</strong> and <strong>architectural presence</strong>.
                    </p>
