...
export default function RS10RailingSystemPage() {
    ...
    try {
      const response = await fetch("https://formspree.io/f/movkdgoa", {
        ...
        body: JSON.stringify({
          ...
          subject: "RS10 Railing System Inquiry",
  ...
  const productSchema = {
    ...
    "description": "Round profile design delivering timeless aesthetics with structural safety for balconies and stairways. Manufactured using high-quality aluminum profiles and can be combined with glass components. Suitable for both residential and commercial projects.",
    "brand": {
      "@type": "Brand",
      "name": "Asay Global"
    },
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Where can the RS10 Railing System be used?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The RS10 Railing System by Asay Global is suitable for balconies, stairways, terraces, and similar architectural areas. It is designed for both residential and commercial projects and can be applied in indoor and outdoor environments."
        }
      },
      {
        "@type": "Question",
        "name": "What materials are used in the RS10 Railing System?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "RS10 is manufactured from high-quality aluminum profiles and can be combined with glass components depending on the selected configuration. This ensures durability, corrosion resistance, and long-term performance."
        }
      },
      {
        "@type": "Question",
        "name": "Is the RS10 Railing System resistant to outdoor conditions?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. Thanks to its aluminum structure and optional anodized or painted surface finishes, the RS10 Railing System is highly resistant to corrosion, moisture, and varying weather conditions."
        }
      },
      {
        "@type": "Question",
        "name": "What installation options are available for RS10?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "RS10 offers flexible installation options including top mount, side mount, and top handle applications. This flexibility allows architects and contractors to adapt the system to different structural and design requirements."
        }
      },
      {
        "@type": "Question",
        "name": "Can RS10 be customized for different architectural styles?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Absolutely. RS10 is available in horizontal, vertical, and glass-holder configurations, with multiple surface finish options, allowing seamless integration into both modern and classic architectural designs."
        }
      }
    ]
  };
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <section className="pt-4">
                ...
                <p className="text-[1rem] leading-relaxed mb-4" style={{ color: "#565656" }}>
                  <strong>Railing Systems</strong> by <strong>Asay Global</strong> are designed to provide <strong>safety</strong> for <strong>balconies</strong>, <strong>stairways</strong>, <strong>terraces</strong>, and similar <strong>architectural spaces</strong> while enhancing the overall <strong>visual identity</strong> of a building. Manufactured using <strong>high-quality aluminum</strong>, <strong>glass</strong>, and carefully engineered <strong>profile combinations</strong>, <strong>Asay Global railing systems</strong> offer <strong>durability</strong>, <strong>long-term performance</strong>, and <strong>minimal maintenance requirements</strong>. Suitable for both <strong>indoor and outdoor applications</strong>, these systems are widely used in <strong>residential and commercial projects</strong>, where <strong>safety</strong> and <strong>architectural consistency</strong> must coexist seamlessly.
                </p>
                <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                  The <strong>RS10 Railing System</strong> by <strong>Asay Global</strong> stands out with its <strong>round profile design</strong>, delivering a <strong>timeless and balanced aesthetic</strong> without compromising <strong>structural safety</strong>. Engineered for <strong>balcony and stairway applications</strong>, <strong>RS10</strong> offers <strong>flexible design solutions</strong> through <strong>horizontal</strong>, <strong>vertical</strong>, and <strong>glass-holder configurations</strong>. Its <strong>corrosion-resistant aluminum structure</strong>, combined with <strong>anodized and painted surface options</strong>, allows the system to adapt effortlessly to various <strong>architectural styles</strong>. Thanks to its <strong>easy installation</strong> and <strong>solid connection details</strong>, <strong>RS10</strong> ensures <strong>efficient application processes</strong> and <strong>reliable, long-lasting performance</strong>.
                </p>
              </section>
              ...
              <section className="pt-4">
                <div className="space-y-12">
                  <h2 className="text-[1.875rem] font-semibold mb-8" style={{ color: "black" }}>Frequently Asked Questions About RS10 Railing System</h2>
                  ...
                  >
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Where can the RS10 Railing System be used?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            The <strong>RS10 Railing System</strong> by <strong>Asay Global</strong> is suitable for <strong>balconies</strong>, <strong>stairways</strong>, <strong>terraces</strong>, and similar <strong>architectural areas</strong>. It is designed for both <strong>residential and commercial projects</strong> and can be applied in <strong>indoor and outdoor environments</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What materials are used in the RS10 Railing System?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>RS10</strong> is manufactured from <strong>high-quality aluminum profiles</strong> and can be combined with <strong>glass components</strong> depending on the selected configuration. This ensures <strong>durability</strong>, <strong>corrosion resistance</strong>, and <strong>long-term performance</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Is the RS10 Railing System resistant to outdoor conditions?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. Thanks to its <strong>aluminum structure</strong> and optional <strong>anodized or painted surface finishes</strong>, the <strong>RS10 Railing System</strong> is highly resistant to <strong>corrosion</strong>, <strong>moisture</strong>, and <strong>varying weather conditions</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What installation options are available for RS10?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>RS10</strong> offers <strong>flexible installation options</strong> including <strong>top mount</strong>, <strong>side mount</strong>, and <strong>top handle applications</strong>. This flexibility allows <strong>architects and contractors</strong> to adapt the system to different <strong>structural and design requirements</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Can RS10 be customized for different architectural styles?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Absolutely. <strong>RS10</strong> is available in <strong>horizontal</strong>, <strong>vertical</strong>, and <strong>glass-holder configurations</strong>, with multiple <strong>surface finish options</strong>, allowing <strong>seamless integration</strong> into both <strong>modern and classic architectural designs</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
              ...
              <section className="pt-4">
                <div className="relative overflow-hidden rounded-2xl p-12 border border-gray-200 shadow-lg" style={{ backgroundColor: "#998675" }}>
                  <div className="relative z-10">
                    <h2 className="text-[1.875rem] font-semibold mb-4 text-white">Discover the RS10 Railing System</h2>
                    <p className="text-[1rem] leading-relaxed mb-8 text-white/95 max-w-2xl">
                      Explore a perfect balance of <strong>safety</strong>, <strong>durability</strong>, and <strong>architectural elegance</strong> with <strong>Asay Global's RS10 Railing System</strong>.
                    </p>
