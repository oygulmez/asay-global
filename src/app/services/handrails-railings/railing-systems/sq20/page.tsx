...
export default function SQ20RailingSystemPage() {
    ...
    try {
      const response = await fetch("https://formspree.io/f/movkdgoa", {
        ...
        body: JSON.stringify({
          ...
          subject: "SQ20 Railing System Inquiry",
  ...
  const productSchema = {
    ...
    "description": "Balanced square profile and enhanced structural depth, offering a more pronounced architectural presence. Ideal for balcony and stairway applications, SQ20 supports horizontal and vertical configurations.",
    "brand": {
      "@type": "Brand",
      "name": "Asay Global"
    },
    ...
    "additionalProperty": [
      ...
      },
      {
        "@type": "PropertyValue",
        "name": "Design Feature",
        "value": "Enhanced Structural Depth, Balanced Square Profile"
      }
    ]
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What type of projects is the SQ20 Railing System suitable for?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "SQ20 is suitable for residential, commercial, and mixed-use projects, particularly where a stronger square-profile appearance is desired."
        }
      },
      {
        "@type": "Question",
        "name": "How does SQ20 differ from SQ10?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "SQ20 features increased profile depth and a more defined structural presence, providing a bolder architectural expression compared to SQ10."
        }
      },
      {
        "@type": "Question",
        "name": "Can SQ20 be used outdoors?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. SQ20 is manufactured from corrosion-resistant aluminum and finished with anodized or painted coatings for outdoor durability."
        }
      },
      {
        "@type": "Question",
        "name": "What installation options are available for SQ20?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "SQ20 supports top-mounted and side-mounted installations, depending on project and structural requirements."
        }
      },
      {
        "@type": "Question",
        "name": "Is SQ20 customizable in terms of finish and layout?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. SQ20 is available in horizontal and vertical configurations with multiple finish options to suit different architectural styles."
        }
      }
    ]
  };
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <section className="pt-4">
                ...
                <p className="text-[1rem] leading-relaxed mb-4" style={{ color: "#565656" }}>
                  <strong>Railing Systems</strong> by <strong>Asay Global</strong> are engineered to deliver <strong>dependable safety solutions</strong> while maintaining <strong>architectural consistency</strong> and <strong>visual balance</strong>. Designed for <strong>balconies</strong>, <strong>stairways</strong>, <strong>terraces</strong>, and <strong>edge protection areas</strong>, these systems combine <strong>aluminum strength</strong> with <strong>refined design details</strong>. Suitable for both <strong>indoor and outdoor applications</strong>, <strong>Asay Global railing systems</strong> provide <strong>durability</strong>, <strong>low maintenance</strong>, and <strong>long-term performance</strong> across <strong>residential and commercial projects</strong>.
                </p>
                <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                  The <strong>SQ20 Railing System</strong> by <strong>Asay Global</strong> is characterized by its <strong>balanced square profile</strong> and <strong>enhanced structural depth</strong>, offering a more <strong>pronounced architectural presence</strong> compared to lighter systems. Ideal for <strong>balcony and stairway applications</strong>, <strong>SQ20</strong> supports <strong>horizontal and vertical configurations</strong>, allowing <strong>flexibility</strong> in <strong>layout and design intent</strong>. Its <strong>corrosion-resistant aluminum construction</strong>, combined with <strong>anodized and painted surface options</strong>, ensures <strong>durability</strong> and <strong>visual integrity</strong> in various <strong>environmental conditions</strong>. <strong>SQ20</strong> is a <strong>reliable choice</strong> for projects seeking a <strong>strong yet refined square-profile railing solution</strong>.
                </p>
              </section>
              ...
              <section className="pt-4">
                <div className="space-y-12">
                  <h2 className="text-[1.875rem] font-semibold mb-8" style={{ color: "black" }}>Frequently Asked Questions About SQ20 Railing System</h2>
                  ...
                  >
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What type of projects is the SQ20 Railing System suitable for?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>SQ20</strong> is suitable for <strong>residential</strong>, <strong>commercial</strong>, and <strong>mixed-use projects</strong>, particularly where a <strong>stronger square-profile appearance</strong> is desired.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          How does SQ20 differ from SQ10?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>SQ20</strong> features <strong>increased profile depth</strong> and a more <strong>defined structural presence</strong>, providing a <strong>bolder architectural expression</strong> compared to <strong>SQ10</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Can SQ20 be used outdoors?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. <strong>SQ20</strong> is manufactured from <strong>corrosion-resistant aluminum</strong> and finished with <strong>anodized or painted coatings</strong> for <strong>outdoor durability</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          What installation options are available for SQ20?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            <strong>SQ20</strong> supports <strong>top-mounted</strong> and <strong>side-mounted installations</strong>, depending on <strong>project and structural requirements</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
                    ...
                    <div className="group">
                      ...
                      >
                        <AccordionTrigger className="cursor-pointer text-[1rem] hover:no-underline" style={{ color: "black" }}>
                          Is SQ20 customizable in terms of finish and layout?
                        </AccordionTrigger>
                        <AccordionContent>
                          <p className="text-[1rem] leading-relaxed" style={{ color: "#565656" }}>
                            Yes. <strong>SQ20</strong> is available in <strong>horizontal and vertical configurations</strong> with <strong>multiple finish options</strong> to suit different <strong>architectural styles</strong>.
                          </p>
                        </AccordionContent>
                      </AccordionItem>
                      <hr className="mx-0 -mb-px group-last:hidden peer-data-[state=open]:opacity-0" />
              ...
              <section className="pt-4">
                <div className="relative overflow-hidden rounded-2xl p-12 border border-gray-200 shadow-lg" style={{ backgroundColor: "#998675" }}>
                  <div className="relative z-10">
                    <h2 className="text-[1.875rem] font-semibold mb-4 text-white">Explore the Architectural Strength of SQ20</h2>
                    <p className="text-[1rem] leading-relaxed mb-8 text-white/95 max-w-2xl">
                      Discover a <strong>square-profile railing system</strong> designed for <strong>clarity</strong> and <strong>structural confidence</strong>.
                    </p>
