...
export const metadata = {
  title: "Legend u-PVC Window and Door System",
  description: "Legend u‑PVC window and door system with 80 mm platform, 6 chambers and triple‑gasket concept for superior insulation and sealing.",
};
...
export default function UPVCWindowDoorSystemsPage() {
  return (
    <>
      <PageHeader
        title="Legend u-PVC Window and Door System"
        description="High-performance u-PVC window and door solutions engineered for insulation, durability and sealing performance."
        breadcrumbItems={[
          { label: "Home", href: "/" },
          { label: "Services", href: "/services" },
          { label: "u-PVC Window & Door Systems", href: "/services/u-pvc-systems/window-door-systems" },
          { label: "Legend u-PVC Window and Door System" },
        ]}
      />
